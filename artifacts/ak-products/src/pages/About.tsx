    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">About AK Products USA</h1>
      ...
      <main className="flex-grow container mx-auto px-4 py-16 max-w-4xl">
        <div className="prose prose-lg prose-blue mx-auto text-gray-700">
          ...
          <p className="mb-6">
            At AK Products USA, our mission is simple: to make everyday tasks easier and more enjoyable. We believe that a well-equipped home is a happy home. By sourcing and designing smart solutions for your kitchen, living spaces, and beyond, we aim to give you back the time you spend on chores so you can focus on what matters most.
          </p>
          ...
          <p className="mb-6">
            Started with a simple realization that many kitchen gadgets on the market were either overpriced or underperforming, AK Products USA was born out of a desire for balance. We wanted reliable, aesthetically pleasing tools that just worked.
          </p>
          <p>
